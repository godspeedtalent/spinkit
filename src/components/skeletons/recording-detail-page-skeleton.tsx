    ...
    <div className="relative min-h-screen animate-pulse">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16 space-y-12">
        <div className="md:grid md:grid-cols-12 md:gap-8 lg:gap-12 items-start">
          ...
          <div className="md:col-span-4 lg:col-span-3 mb-8 md:mb-0">
            <div className="sticky top-20">
              <Skeleton className="w-full aspect-square rounded-lg shadow-2xl" />
          ...
          <div className="md:col-span-8 lg:col-span-9">
            <div className="lg:grid lg:grid-cols-3 lg:gap-8">
              <div className="lg:col-span-2">
                ...
                <Skeleton className="h-6 w-1/2 mb-1 rounded" /> {/* Artist */}
                ...
                <Skeleton className="h-5 w-1/3 mb-4 rounded" /> {/* Total Plays */}
              </div>
              
              <div className="lg:col-span-1 space-y-8 mt-8 lg:mt-0">
                 <div>
                  <Skeleton className="h-6 w-3/5 mb-3 rounded" /> {/* More by Artist Title */}
                  <div className="space-y-3">
                    <Skeleton className="h-10 w-full rounded-md" />
                    <Skeleton className="h-10 w-full rounded-md" />
                  </div>
                </div>
                <Skeleton className="h-9 w-full rounded-md" /> {/* View Artist Button */}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-10">
            <div>
                <Skeleton className="h-8 w-1/3 mb-4 rounded" /> {/* Rate this Recording Title */}
                <Card><CardContent className="p-4 space-y-2">
                    <Skeleton className="h-6 w-28 rounded" />
                    <Skeleton className="h-5 w-full rounded-full" /> {/* Slider Track */}
                    <Skeleton className="h-8 w-28 rounded-md" />
                </CardContent></Card>
            </div>
             <div>
                <Skeleton className="h-8 w-1/4 mb-4 rounded" /> {/* Comments Section Title */}
                <Card>
