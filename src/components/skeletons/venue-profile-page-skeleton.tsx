...
export function VenueProfilePageSkeleton() {
  return (
    <div className="relative min-h-screen animate-pulse">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16 space-y-12">
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-8">
              <div className="lg:col-span-2">
                ...
                <div className="flex space-x-3 mb-8">
                  <Skeleton className="h-11 w-40 rounded-md" /> {/* Button */}
                ...
                <Skeleton className="h-6 w-1/3 mb-3 rounded" /> {/* Venue Details Title */}
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm mb-8">
                ...
                <Skeleton className="h-6 w-1/3 mb-3 rounded" /> {/* Genres Needed Title */}
              ...
              <div className="lg:col-span-1 space-y-8 mt-8 lg:mt-0">
                <div>
                  <Skeleton className="h-6 w-3/5 mb-3 rounded" /> {/* Upcoming Events Title */}
                 ...
                 <div>
                  <Skeleton className="h-6 w-3/5 mb-3 rounded" /> {/* Booked DJs Title */}
                  <div className="space-y-3">
        ...
        <div className="max-w-3xl mx-auto">
            <Skeleton className="h-8 w-1/3 mb-4 rounded" /> {/* Section Title */}
            <Card>
